...
public class Carnes {
   ...
   // @NotNull(message = "Debes especificar la existencia")
    ...
    public Carnes(String nombre, String codigo, Float precio, Float existencia, Integer id, BigDecimal iva,Float descuento, Categoria categoria, Float precio_final) {
        this.nombre = nombre;
        this.codigo = codigo;
        this.precio = precio;
    ...
    public Carnes(String nombre, String codigo, Float precio, Float existencia,BigDecimal iva, Float precio_final) {
        this.nombre = nombre;
        this.codigo = codigo;
        this.precio = precio;
        this.iva = iva;
    ...
    public Carnes(@NotNull(message = "Debes especificar el código") @Size(min = 1, max = 50, message = "El código debe medir entre 1 y 50") String codigo) {
        this.codigo = codigo;
    }
