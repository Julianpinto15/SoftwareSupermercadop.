...
public class Fruvert {
   ...
   // @NotNull(message = "Debes especificar la existencia")
    ...
    private Float precio_final; // precio final
    ...
    public Fruvert(String nombre, String codigo, Float precio, Float existencia, Float precio_final, BigDecimal iva, Float descuento,Integer id, Categoria categoria) {
        this.nombre = nombre;
        this.codigo = codigo;
    ...
    /*lo que manda a llamr*/
    public Fruvert(String nombre, String codigo, Float precio, Float existencia, BigDecimal iva, Float precio_final) {
        this.nombre = nombre;
        this.codigo = codigo;
        this.precio = precio;
        this.existencia = existencia;
    ...
    public Fruvert(@NotNull(message = "Debes especificar el código") @Size(min = 1, max = 50, message = "El código debe medir entre 1 y 50") String codigo) {
        this.codigo = codigo;
    }
